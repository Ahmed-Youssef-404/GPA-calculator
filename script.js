...
//                 <input type="number" id="credits${i}" placeholder="Enter credits for subject ${i}">
//             </div>
//         `;
//     }
// });
...
//     if (!isValid) {
//         alert("Please fill in all the subject grades and credits.");
//         return;
//     }
...
//     document.getElementById('currentGPA').innerText = `Current Semester GPA: ${currentGPA.toFixed(2)}`;
//     document.getElementById('newTotalGPA').innerText = `New Total GPA: ${newTotalGPA.toFixed(2)}`;
// }
